      ...
      <div className="grid grid-cols-2 gap-x-3 gap-y-3 justify-around mt-4 ">
        <Card className="border-none py-2">
            ...
            <div className=" divide-y space-y-5 mt-2">
              <div className="flex items-center justify-between gap-x-3">
                ...
                <p>
                  ...
                  <span className="text-yellow-500 text-base font-semibold font-['Poppins']">
                    $
                  </span>
                  <span className="text-zinc-800 text-base font-semibold font-['Poppins']">
                    5.59
          ...
          <CardFooter className="text-zinc-400 text-base font-normal font-['Poppins'] px-4">
            <Button
              className="w-full bg-lime-50 border border-lime-300 text-lime-500 hover:bg-lime-50 hover:text-lime-500"
              variant={"outline"}
            >
              Completed
            </Button>
        ...
        <Card className="border-none py-2">
          ...
          <CardFooter className="text-base font-normal font-['Poppins'] px-4">
            <Button
              className="w-full bg-orange-50 border border-orange-300 text-orange-400 hover:bg-orange-50 hover:text-orange-400"
              variant={"outline"}
            >
              Develiring To You
            </Button>
        ...
        <Card className="border-none py-2">
          ...
          <CardFooter className="text-zinc-400 text-base font-normal font-['Poppins'] px-4">
            <Button
              className="w-full bg-blue-50 border border-blue-300 text-blue-400 hover:bg-blue-50 hover:text-blue-400"
              variant={"outline"}
            >
