                ...
                <Card className="w-60 border-none py-2 flex flex-col">
                    ...
                    <CardContent className="flex flex-col justify-center">
                        ...
                        <div className='flex items-center gap-x-2 pt-2'>
                            <Image src={Star} alt="Star" className="inline-block" width={15} />
                            <div className="w-1 h-1 bg-zinc-400 rounded-full"></div>
                            <p className="text-xs text-zinc-400 font-['Poppins']">1K+ reviews</p>
                            <div className="w-1 h-1 bg-zinc-400 rounded-full"></div>
                    ...
                    <CardFooter className=" text-base font-normal font-['Poppins'] px-4 flex justify-between items-center border-t-[1.5px]">
                        ...
                        <Button size={'sm'} className='bg-primary text-white mt-2 rounded-lg'>
            ...
            <article className='absolute bottom-0 w-full'>
                <div className='flex justify-between items-center'>
                    <div className="text-sm font-['Poppins'] text-zinc-500">
                        <p className=''>Showing <span className='text-black font-semibold'>1-5</span> from <span className='text-black font-semibold'>100</span> data</p>
                    </div>
                    <div className='flex items-center gap-x-3'>
                        ...
                        {[1, 2, 3].map((_, i) => (
                            <Button key={i} className='bg-orange-100 text-orange-400 hover:bg-orange-100 rounded-xl'>
                                {i + 1}
                            </Button>
                        ))}
                        <Button className='bg-transparent text-zinc-400 hover:bg-transparent'>
