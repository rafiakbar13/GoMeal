            ...
            <div className='w-12/12 flex justify-between items-center gap-x-4 flex-col md:flex-row'>
                <div className='md:w-6/12'>
                    <div className='flex items-center gap-x-3 relative'>
                        <h1 className='text-7xl md:text-9xl font-semibold tracking-wide text-primary'>Fast</h1>
                        <div className='relative'>
                            <h1 className='text-5xl font-semibold'>
                                Food
                            </h1>
                            <h1 className='text-2xl md:text-5xl font-semibold'>Delivery</h1>
                            <Image src={Arrow} alt='arrow' className='hidden md:block absolute left-28 -top-28 w-40' />
                        </div>
                    </div>
                    ...
                    <div className='pt-10 flex md:gap-x-8 flex-col md:flex-row gap-y-3'>
                        ...
                        <Button className='rounded-full bg-slate-950 text-white'>Learn More</Button>
                    </div>
